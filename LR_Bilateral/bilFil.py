...
if __name__ == '__main__':
    ...
    # res_GPU = np.zeros((w, h), dtype=np.uint8)
    # res_GPU = cuda.to_device(res_GPU)
    #
    # GPU_bilateral_filter[blocks_per_grid, threads_per_block](d_img_array, res_GPU)
    # result_GPU = res_GPU.copy_to_host()
    # print(result_GPU)
    # PIL_image = Image.fromarray(result_GPU, mode='L')
    ...
    # new_img.show()
    # res_cpu = CPU_bilateral_filter(new_img)
    # print(res_cpu)
    # PIL_image = Image.fromarray(res_cpu, mode='L')
