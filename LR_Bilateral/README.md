...
| Разрешение  | Время работы CPU в секундах | Время работы GPU в секундах <br /> GridDim (2,2),BlockDim(5,5) | Время работы GPU в секундах <br /> GridDim (4,4),BlockDim(8,8) |
|-------------|:----------------:|-----------------:|-----------------:|
...
![Рисунок](https://github.com/BandooSs/my_HPC-Samara/blob/main/LR_Bilateral/result/CPU_100x100.bmp)


Пример работы представлен ниже GPU: <br />
![Рисунок](https://github.com/BandooSs/my_HPC-Samara/blob/main/LR_Bilateral/result/GPU_100x100.bmp)
